...
import { SAMPLE_PM_REVIEW_CHECKS } from "../data/reportEditorSampleData";
...
export default function PMReviewPanel() {
  ...
  const allPass = SAMPLE_PM_REVIEW_CHECKS.every((c) => c.status !== "fail");
